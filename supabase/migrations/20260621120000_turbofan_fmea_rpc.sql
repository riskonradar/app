...
AS $$
  ...
  failure_map(alias, label) AS (VALUES
    ...
    ('low cycle fatigue','Fatigue'),('low-cycle fatigue','Fatigue'),('lcf','Fatigue'),('high cycle fatigue','Fatigue'),('high-cycle fatigue','Fatigue'),('hcf','Fatigue'),('very high cycle fatigue','Fatigue'),('very-high-cycle fatigue','Fatigue'),('vhcf','Fatigue'),('thermomechanical fatigue','Fatigue'),('thermo-mechanical fatigue','Fatigue'),('tmf','Fatigue'),('thermal fatigue','Fatigue'),('fretting fatigue','Fatigue'),('dwell fatigue','Fatigue'),('fatigue failure','Fatigue'),('fatigue crack','Fatigue'),('fatigue life','Fatigue'),('fatigue','Fatigue'),
    ('crack','Crack / fracture'),('cracks','Crack / fracture'),('cracking','Crack / fracture'),('fracture','Crack / fracture'),('rupture','Crack / fracture'),('burst','Crack / fracture'),('burn-through','Burn-through'),('burned-through','Burn-through'),('breakage','Crack / fracture'),
    ...
    ('flexural vibration','Deformation / buckling'),('flexural deformation','Deformation / buckling'),('bulging','Deformation / buckling'),('oxidation','Oxidation'),('overspeed','Overspeed'),('over-speed','Overspeed'),('corrosion','Corrosion / pitting'),('rusting','Corrosion / pitting'),('rustiness','Corrosion / pitting'),('hot corrosion','Corrosion / pitting'),('pitting','Corrosion / pitting'),('thermal shock','Thermal shock'),('combustion instability','Combustion instability'),('oil leakage','Leakage'),('oil leak','Leakage'),('fuel leakage','Leakage'),('fuel leak','Leakage'),('leakage','Leakage'),('leak','Leakage'),('misalignment','Misalignment'),('overtemperature','Overheating / overtemperature'),('overheating','Overheating / overtemperature'),('bearing fault','Bearing fault'),('bearing faults','Bearing fault'),('bearing defect','Bearing fault'),('ball-bearing faults','Bearing fault'),('seizure','Seizure'),('bearing seizure','Seizure'),('spallation','Spallation'),('spalling','Spallation'),('bearing spallation','Spallation'),('thermal barrier coating spallation','Spallation'),('delamination','Delamination'),('debonding','Debonding'),('coating failure','Coating failure'),('contamination','Contamination'),('loss of pressure','Pressure loss'),('pressure loss','Pressure loss'),('uncontained failure','Uncontained failure'),('uncontained','Uncontained failure'),('malfunction','Functional failure')
  ),
